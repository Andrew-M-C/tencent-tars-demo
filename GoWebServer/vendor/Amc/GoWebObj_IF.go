...
//GoWebObj struct
type GoWebObj struct {
	s m.Servant
}

//Add is the proxy function for the method defined in the tars file, with the context
func (_obj *GoWebObj) Add(A int32, B int32, C *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWebObj) AddWithContext(ctx context.Context, A int32, B int32, C *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWebObj) Sub(A int32, B int32, C *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWebObj) SubWithContext(ctx context.Context, A int32, B int32, C *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWebObj) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *GoWebObj) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}
func (_obj *GoWebObj) setMap(l int, res *requestf.ResponsePacket, ctx map[string]string, sts map[string]string) {
	if l == 1 {
		for k, _ := range ctx {
			delete(ctx, k)
		}
...
func (_obj *GoWebObj) AddServant(imp _impGoWebObj, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *GoWebObj) AddServantWithContext(imp _impGoWebObjWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impGoWebObj interface {
	Add(A int32, B int32, C *int32) (ret int32, err error)
	Sub(A int32, B int32, C *int32) (ret int32, err error)
}
type _impGoWebObjWithContext interface {
...
func Add(ctx context.Context, _val interface{}, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	...
	if withContext == false {
		...
		_imp := _val.(_impGoWebObjWithContext)
...
func (_obj *GoWebObj) Dispatch(ctx context.Context, _val interface{}, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
